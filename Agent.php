	...
	<?php while($data=$sel->fetch(PDO::FETCH_ASSOC))
	{
      ...
      echo"<br/>";
			...
			if( $left_rec > $rec_limit && $page != 0 )
			{
			   ...
			   $last = $page - 2;
			   echo "<a class=\"pagination_button\" href=\"Agent.php?page=$last\"Previous</a> |";
			   echo "<a class=\"pagination_button\" href=\"Agent.php?page=$page\">Next</a>";
			}
			if( $page == 0 )
			{
