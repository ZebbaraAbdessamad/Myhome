...
<body>
      ...
      $getdata=$connect->query($sql);
        ...
        $sql= "select * from logements,agents where (genre_Lg='Rent' and Etat_Lg='1') and agents.Aid=logements.Aid LIMIT $offset, $rec_limit";
...
<?php } ?>
      ...
      echo"<br/>";
			...
			if( $left_rec > $rec_limit && $page != 0 )
			{
			   ...
			   $last = $page - 2;
			   echo "<a class=\"pagination_button\" href=\"Louer-Ag.php?page=$last\">Previous</a> |";
         echo"<br/>";
			   echo "<a class=\"pagination_button\" href=\"Louer-Ag.php?page=$page\">Next</a>";
			}
			if( $page == 0 )
			{
