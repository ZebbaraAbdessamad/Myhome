...
$sql= "select * from logements,agents where logements.Aid=agents.Aid";
...
?>
          ...
          <td class="center"> 
                  ...
                  <?php if($row['Etat_Lg']=='1'){?>
                       <a href="gestion_Property.php?Lid_inactive=<?php echo $row['Lid'];?>"> <button type="submit"  class="btn btn-success" name="active">Active</button></a>
										<?php }else{?>
                       <a href="gestion_Property.php?Lid_active=<?php echo $row['Lid'];?>"> <button type="submit" class="btn btn-danger" name="inactive">Inactive</button></a>
               <?php }?>	
          </td>

        <td class="center"> 
  <a   href="gestion_Property.php?Edite_Lid=<?php echo $row['Lid'];?>" data-toggle="modal" data-target="#edit_<?php echo $row['Lid']; ?>" class="btn btn-info" name="Edite" >
              <i class="glyphicon  glyphicon-edit"></i>  </a>

               <a class="btn btn-danger" href="gestion_Property.php?property_Lid=<?php echo $row['Lid'];?>" title="Delete Agent" onClick="return confirm('Delete this Property?')">
            ...
            {  
                ...
                echo"<script>location.href='gestion_Property.php'</script>";
          ...
          <div class="modal" id="edit_<?php echo $row['Lid']; ?>">
            ...
            <form method="post" action="Up_Property.php"  role="form">

                <label style="color:#999; font-size:20px;">Property Title:</label>
                        <input type="text" class="form-control" name="title" value="<?php echo $row['Titre_Lg']; ?>" placeholder="<?php echo $row['Titre_Lg']; ?>" style="height: 50px;">
                        <br/>
                        ...
                        <br/>
                        <img  name="od_img" src="/Logement/<?php echo $row['image_Lg']; ?>" height="100" width="100">
                        <br/>
                        <br/>
