...
$sql= "select * from logements,agents where logements.Aid=agents.Aid and genre_Lg='Rent' ";
...
?>
          ...
          <td class="center"> 
                  ...
                  <?php if($row['Etat_Lg']=='1'){?>
                       <a href="Pr_for_Rent.php?Lid_inactive=<?php echo $row['Lid'];?>"> <button type="submit"  class="btn btn-success" name="active">Active</button></a>
										<?php }else{?>
                       <a href="Pr_for_Rent.php?Lid_active=<?php echo $row['Lid'];?>"> <button type="submit" class="btn btn-danger" name="inactive">Inactive</button></a>
               <?php }?>	
          </td>

        <td class="center"> 
  <a   href="Pr_for_Rent.php?Edite_Lid=<?php echo $row['Lid'];?>" data-toggle="modal" data-target="#edit_<?php echo $row['Lid']; ?>" class="btn btn-info" name="Edite" >
              <i class="glyphicon  glyphicon-edit"></i>  </a>

               <a class="btn btn-danger" href="Pr_for_Rent.php?property_Lid=<?php echo $row['Lid'];?>" title="Delete Agent" onClick="return confirm('Delete this Property?')">
            ...
            {  
                ...
                echo"<script>location.href='Pr_for_Rent.php'</script>";
		...
		<form action="Up_Pr_for_Rent.php" method="POST" role="form">
